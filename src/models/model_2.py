...
code_layer = MaxPooling2D(pool_factor, name='code_layer')(conv_2)

unconv_layer_1 = Conv2DTranspose(8, (3,3), activation='relu', padding='same', name='unconv_layer_1')(code_layer)
